...
if __name__ == '__main__':
    ...
    jakuplist = ['017670', '030000', '030200', '032640', '035420', '036570']

    savePATH = 'p_dqn_train_3'
    ...
    for targetcode in jakuplist:
        ...
        file_handler = logging.FileHandler(filename=os.path.join(
            output_path, "dqn_test.log"), encoding='utf-8')
        ...
        files = os.listdir(os.path.join(settings.BASE_DIR, 'output', 'p_dqn_train', targetcode))  # a2c 모델들 저장한 루트
        file_h5 = [file for file in files if file.endswith(".h5")]

        value_network_path = os.path.join(settings.BASE_DIR,
                                          'output/p_dqn_train/{}/{}'.format(targetcode, file_h5[0]))
