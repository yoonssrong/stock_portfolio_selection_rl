...
if __name__ == '__main__':
    ...
    parser.add_argument('--ver', choices=['v1', 'v2', 'c', 'p'], default='v2')
    ...
    jakuplist = ['030000', '035420']

    savePATH = 'p_a2c_train_7'
    ...
    for targetcode in jakuplist:
        ...
        file_handler = logging.FileHandler(filename=os.path.join(
            output_path, "a2c_test.log"), encoding='utf-8')
        ...
        from learners2 import DQNLearner, PolicyGradientLearner, \
        ...
        files = os.listdir(os.path.join(settings.BASE_DIR, 'output', 'p_a2c_train', targetcode))  # a2c 모델들 저장한 루트
        file_h5 = [file for file in files if file.endswith(".h5")]

        value_network_path = os.path.join(settings.BASE_DIR,
                                          'output/p_a2c_train/{}/{}'.format(targetcode, file_h5[1]))
        policy_network_path = os.path.join(settings.BASE_DIR,
                                           'output/p_a2c_train/{}/{}'.format(targetcode, file_h5[0]))
