...
gExcelFile = './data/raw/investor/{}.xlsx'.format(targetCode[1:])
...
class CpRp7354:
    def Request(self, code, caller):
        ...
        # objRq.SetInputValue(2, '20190101')  # 종료일
        # objRq.SetInputValue(3, '20180101')  # 시작일
...
class MyWindow(QMainWindow):
    ...
    def btnStart_clicked(self):
        ...
        obj7254 = CpRp7354()
        obj7254.Request(targetCode, self)
